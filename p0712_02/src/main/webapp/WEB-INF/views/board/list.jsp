...
<section>
	...
	<ul class="page-num">
      ...
      <c:if test="">
      	<a href="list?page="><li class="prev"></li></a>
      </c:if>
      <!-- 현재페이지-->
	  <c:forEach var="i" begin="" end="" step="1">
	  <c:if test="">
	   <li class="myNum num"><div></div></li>
	  </c:if>
	  <c:if test="">
	  <a href="list?page="><li class="num"><div></div></li></a>
	  </c:if>
	  </c:forEach>

      <c:if test="">
      	<a href="list?page="><li class="next"></li></a>
      </c:if>
      <c:if test="">
      	<li class="next"></li>
      </c:if>
      <c:if test="">
      	<a href="list?page="><li class="last"></li></a>
      </c:if>
      <c:if test="">
      	<li class="last"></li>
      </c:if>
    ...
    <a href=""><div class="write">쓰기</div></a>
  </section>
